...
public class PersonaJuridica extends Persona{
    ...
    public PersonaJuridica(int digitoVerificacion, String descripcionActividad, int identificacion, String tipoIdentificacion, String nombre, String telefono, String correo, Date fechaNacimiento, boolean esAdmin) {
